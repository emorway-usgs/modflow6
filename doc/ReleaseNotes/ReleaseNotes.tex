...
\item
The Time-Variable Hydraulic Conductivity (TVK) Package is incompatible with the Hydraulic Flow Barrier (HFB) Package if the TVK Package is used to change hydraulic properties of cells near hydraulic flow barriers.
