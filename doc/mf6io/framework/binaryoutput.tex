...
\texttt{STORAGE-CELLBLK} & 1 & energy aqueous storage; array of size (NCELLS) \\
\texttt{DECAY-AQUEOUS} & 1 & energy aqueous decay; array of size (NCELLS) \\
\texttt{DECAY-SOLID} & 1 & energy solid decay; array of size (NCELLS) \\
...
\texttt{STORAGE} & 6 & particle mass flow for cell storage \\
\texttt{TERMINATION} & 6 & terminating particle mass flow \\
\label{table:prtbud}
\end{longtable}
