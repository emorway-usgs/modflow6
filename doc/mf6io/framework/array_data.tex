...
INTERNAL FACTOR 1.0 IPRN 3        # This reads the array values from the file that contains the control line. 
 1.2 3.7 9.3 4.2 2.2 9.9 1.0      # Thus, the values immediately follow the control line.
