Observations are available for GWT models and GWT stress packages. Available observation types have been listed for each model and each package and exchange that supports observations (tables~\ref{table:gwtobstype} to~\ref{table:gwt-uztobstype}). All available observation types are repeated in Table~\ref{table:gwt-obstypetable} for convenience. 
