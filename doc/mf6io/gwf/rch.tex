...
\mf will allow recharge in cells that also include a lake connection.  Refer to the ``\hyperref[sec:lakrchet]{Use of the Lake Package with RCH and EVT Packages}'' section for additional details when the RCH and LAK packages are active in the same cell.  
