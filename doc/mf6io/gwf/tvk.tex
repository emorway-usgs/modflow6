Input to the Time-Varying Hydraulic Conductivity (TVK) Utility is read from the file that is specified in the TVK6 record of the OPTIONS block in the NPF package.
